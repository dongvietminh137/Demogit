...
const FirstScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.firstContainer}>
      <Image
        source={require('./assets/Nectar.png')}
...
const Onboarding = ({ navigation }) => {
  return (
    <View style={styles.onboardingContainer}>
      <Image
        source={require('./assets/anh3.jpg')}
...
const SignIn = ({ navigation }) => {
  return (
    <View style={styles.SignInContainer}>
      <Image
          source={require('./assets/raucu.jpg')}
    ...
    <View style={styles.numberContainer}>
      ...
      <View style={{flex:1,alignItems:'center',height:100}}>
        <View style={{flexDirection: 'row',
                      ...
                      width:380,
                      padding: 8,}}>
          <Image source={require('./assets/daymslaicon.jpg')} style={{width:40,marginBottom:5}} />
          <TextInput
              style={styles.input1}
              keyboardType="phone-pad"
              value={phoneNumber}
